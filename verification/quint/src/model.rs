...
const MODELS: &[ModelDescriptor] = &[
    ModelDescriptor {
        ...
        properties: &[
            ...
            invariant("CompleteReservation"),
            invariant("PublicationConsumesReservation"),
            invariant("CancellationRefundsCapacity"),
            invariant("ResetInvalidatesEventOwnership"),
        ],
        actions: &[
            "Begin",
            "StageWrite",
    ...
    ModelDescriptor {
        ...
        properties: &[
            ...
            invariant("PublicationRequiresOwnedStage"),
            invariant("RefusalPreservesPublicArtifact"),
            invariant("RefusalPreservesChangedStage"),
        ...
        production_sources: &[
            "crates/fireemu-export-publication/src/lib.rs",
            "crates/fireemu/src/import_export.rs",
        ],
        bounds: &[BoundDescriptor {
            name: "Domain",
            value: "finite-enumerated",
        }],
        scenarios: &["publish", "refuse", "replace", "stageReplace"],
        projection_fields: &[
            "stageState",
            "stageIdentity",
            "targetIdentity",
    ...
    ModelDescriptor {
        ...
        properties: &[
            ...
            invariant("WindowBounded"),
            invariant("WindowAccounting"),
            invariant("EvictionIsNotCompletion"),
    ...
    ModelDescriptor {
        name: "CompatibilitySelection",
        spec: "specs/CompatibilitySelection.qnt",
        main: "CompatibilitySelectionProof",
        config: "configs/CompatibilitySelection.json",
        mutation_manifest: "mutations/CompatibilitySelection.json",
        properties: &[
            invariant("TypeOK"),
            invariant("NoStoreAliases"),
            invariant("UniqueUserRoutesToItsProject"),
            invariant("UnknownUserUsesDefault"),
            invariant("AmbiguousUserIsDenied"),
            invariant("AutomaticSelectionIsCapable"),
            invariant("RequestedNodeBreaksCapabilityTies"),
            invariant("ExplicitSelectionIsStable"),
        ],
        actions: &["Evaluate"],
        production_sources: &[
            "crates/fireemu-core-auth/src/store.rs",
            "crates/fireemu-adapter-functions/src/node_selection.rs",
            "crates/fireemu-adapter-http/src/identity_toolkit.rs",
            "crates/fireemu/src/functions.rs",
        ],
        bounds: &[
            BoundDescriptor {
                name: "Projects",
                value: "{default,worker-a,worker-b}",
            },
            BoundDescriptor {
                name: "Stores",
                value: "{store-default,store-a,store-b}",
            },
            BoundDescriptor {
                name: "Nodes",
                value: "{node22old,node20new,node22new}",
            },
        ],
        scenarios: &[
            "default",
        ...
        driver: "verification/quint/src/compatibility_selection.rs",
        connect_test: "verification/quint/tests/compatibility_selection_connect.rs",
        additional_evidence_inputs: &[
            "crates/fireemu-core-auth/tests/store.rs",
    ...
    ModelDescriptor {
        name: "FirestoreListenRefresh",
        spec: "specs/FirestoreListenRefresh.qnt",
        main: "FirestoreListenRefreshProof",
        config: "configs/FirestoreListenRefresh.json",
        mutation_manifest: "mutations/FirestoreListenRefresh.json",
        properties: &[
            invariant("TypeOK"),
            invariant("ExactContiguousVersionBoundary"),
            invariant("ChangedPathsAreUnioned"),
            invariant("VersionGapFallsBack"),
            invariant("ResetFallsBack"),
            invariant("GenerationChangeInvalidatesTarget"),
            invariant("UnsafeQueryFallsBack"),
            invariant("FullFallbackIsSticky"),
            invariant("RefreshCommitsExactBoundary"),
            invariant("IncrementalOnlyForSafeExactDelta"),
            invariant("IncrementalProjectionEquivalent"),
            invariant("FiftyTargetsOneChangeIsLinear"),
            invariant("FullRefreshExaminesNoDeltaRows"),
            invariant("GenerationResetReplaysEveryTarget"),
        ],
        actions: &[
            "QueueContiguous",
            "QueueGap",
        ...
        driver: "verification/quint/src/firestore_listen_refresh.rs",
        connect_test: "verification/quint/tests/firestore_listen_refresh_connect.rs",
        additional_evidence_inputs: &["crates/fireemu-core-firestore/src/query.rs"],
    },
    ModelDescriptor {
    ...
    ModelDescriptor {
        ...
        config: "configs/RegexLinearRepeat.json",
        mutation_manifest: "mutations/RegexLinearRepeat.json",
        properties: &[
            invariant("TypeOK"),
            invariant("AtomicProgressDoesNotIncreaseDepth"),
            invariant("MatchedImpliesEveryCharacterAccepted"),
            invariant("ForbiddenCharacterNeverMatches"),
            invariant("WorkIsCharged"),
            invariant("EveryAtomicBranchProbeIsCharged"),
            invariant("ExhaustionStartsOnlyFromRunning"),
            invariant("BudgetExhaustionNeverMatches"),
            invariant("NonAtomicFallsBack"),
            invariant("AtomicConsumeAdvancesOneChargedCharacter"),
            invariant("AtomicProbeMissAdvancesOneChargedProbe"),
            invariant("AtomicRejectIsOneChargedBoundedProbe"),
            invariant("FallbackAdvancesOneChargedFrame"),
            invariant("ExhaustionRequiresABudgetBoundary"),
        ],
        actions: &["Evaluate"],
        production_sources: &["crates/fireemu-core-rules/src/regex.rs"],
        bounds: &[
            BoundDescriptor {
                name: "SubjectLength",
                value: "3",
        ...
        projection_fields: &["outcome", "workClass", "depthClass", "probeAccounting"],
        driver: "verification/quint/src/regex_linear_repeat.rs",
        connect_test: "verification/quint/tests/regex_linear_repeat_connect.rs",
        additional_evidence_inputs: &[],
    },
    ModelDescriptor {
        ...
        properties: &[
            ...
            invariant("EvaluationSnapshotIsImmutable"),
        ...
        production_sources: &["crates/fireemu-core-rules/src/runtime.rs"],
        bounds: &[
            BoundDescriptor {
                name: "Evaluations",
                value: "{r1,r2}",
        ...
        scenarios: &["activate", "reject", "pinEvaluation", "pinGeneration"],
        projection_fields: &[
            "activeVersion",
            "generation",
            "evaluationVersion",
    ...
    ModelDescriptor {
        name: "TransactionConditionalLock",
        spec: "specs/TransactionConditionalLock.qnt",
        main: "TransactionConditionalLockProof",
        config: "configs/TransactionConditionalLock.json",
        mutation_manifest: "mutations/TransactionConditionalLock.json",
        properties: &[
            invariant("TypeOK"),
            invariant("OneWinner"),
        ...
        additional_evidence_inputs: &[
            ...
            "conformance/functions/index.js",
            "conformance/fixtures/firestore/transaction-read-set-abort.json",
            "conformance/fixtures/functions/concurrent-conditional-lock.json",
        ],
    },
];
