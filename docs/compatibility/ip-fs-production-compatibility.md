...
| --- | --- | --- | --- | --- |
| AUTH-ACCOUNT | Create/get/search/list/update/delete, disable/re-enable, email/password/anonymous/phone/provider lifecycle, Admin batch/import/export, protected fields and configured policies | Bounded production account/update receipts and repaired 45/46-row slices; 4,096 UTF-16 password boundaries across public mutation routes; import failure atomicity and rich default/tenant round trips | `IMPLEMENTING` | Provider lifecycle, remaining hash formats, configured policies and unobserved value/state classes need final-runtime production comparison. |
