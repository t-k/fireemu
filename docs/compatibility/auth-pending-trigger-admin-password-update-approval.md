# Held MFA pending credential across admin-password-update: scoped human approval
...
[Approval record](../../spec/compatibility/evidence/auth-pending-trigger-admin-password-update/approval.json) · [Receipt](../../spec/compatibility/evidence/auth-pending-trigger-admin-password-update/receipt.json) · [Candidate page](auth-pending-trigger-admin-password-update.md).
