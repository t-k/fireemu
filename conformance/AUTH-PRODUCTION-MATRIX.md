...
Fireemu observation: live artifact fireemu (sha256-d22dc4e7c483c6c1cad05bb9c3412ef8df60cca883dce677182c796aff879430), source 2ec9758a99952d9db976ccc05bd92fa12a81ec8f, profile firebase.
...
Official emulator values: stored expectation from auth-matrix.json (sha256-6b23470d070ae9d8c4c98859fdbf9a409cbed81ce9ae6a45d489163747c2cd65).
Evidence status: verified.

| status | rows | meaning |
| --- | --- | --- |
| parity | 14 | production, the official emulator and fireemu agree |
| fireemu-matches-production | 9 | fireemu follows production where the official emulator differs |
| fireemu-divergence | 0 | production and the official emulator agree; fireemu differs |
| emulators-diverge-from-production | 0 | both emulators agree with each other but not with production |
...
| tokens/errors#unknown-method | fireemu-matches-production | {"status":404,"code":"non-json"} | {"status":404,"code":"Not"} | {"status":404,"code":"non-json"} |
