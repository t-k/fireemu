"""Build and own the strict Auth artifact; run the pending-lifetime corpus against it,
aging pendings by advancing the owned instance's virtual clock. Never attaches to an
external daemon."""
...
def run(output):
    ...
    with tempfile.TemporaryDirectory(
        prefix="fireemu-pending-lifetime-owned-"
    ) as temporary:
...
if __name__ == "__main__":
    ...
    try:
        ...
        raise SystemExit(
            "Pending-lifetime owned observation did not complete"
        ) from None
