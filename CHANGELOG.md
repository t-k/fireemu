...
- Strict profile: a phone enrollment session does not expire, instead of lasting the ten minutes of a phone code. Production accepted sessions of every age it was shown, up to about 1803 seconds (sandbox recording 2026-09-24, `auth-mfa/lifetime`), and refused none. At the cap of 1000 outstanding phone codes the oldest enrollment session older than that makes room. Other phone codes and the emulator profile keep ten minutes.
