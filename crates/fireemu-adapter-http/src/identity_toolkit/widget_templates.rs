...
/// The widget HTML before the injected provider-account list.
pub(super) const WIDGET_BEFORE_PROVIDERS: &str = r#"
<!DOCTYPE html>
<meta charset="utf-8">
...
/// The widget HTML after the injected provider-account list.
pub(super) const WIDGET_AFTER_PROVIDERS: &str = r#"
...
/// The `/emulator/auth/iframe` helper page (static; all logic is client-side).
pub(super) const IFRAME_HTML: &str = r#"<!DOCTYPE html>
<meta charset="utf-8">
