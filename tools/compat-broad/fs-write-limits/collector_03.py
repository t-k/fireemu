...
def collect(gate, plan, output, wire, *, before_recovery=None, excused=()):
    ...
    try:
        ...
        # As in limits-02, never acquire recovery credentials after an
        # unconfirmed transition. With no callback, the Gate still decides
        # every recovery dispatch; a failed transition is never bypassed.
