...
pub mod write {
    ...
    pub enum Operation {
        ...
        /// fireemu patch (not in the public proto): the name of a document on which to
...
pub mod firestore_server {
    ...
    pub trait Firestore: std::marker::Send + std::marker::Sync + 'static {
        ...
        type ExecutePipelineStream: tonic::codegen::tokio_stream::Stream<
                Item = std::result::Result<super::ExecutePipelineResponse, tonic::Status>,
            >
            + std::marker::Send
            + 'static;
        /// Executes a pipeline query.
        async fn execute_pipeline(
            &self,
            request: tonic::Request<super::ExecutePipelineRequest>,
        ) -> std::result::Result<
            tonic::Response<Self::ExecutePipelineStream>,
            tonic::Status,
        >;
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/google.firestore.v1.Firestore/ExecutePipeline" => {
                    #[allow(non_camel_case_types)]
                    struct ExecutePipelineSvc<T: Firestore>(pub Arc<T>);
                    impl<
                        T: Firestore,
                    > tonic::server::ServerStreamingService<
                        super::ExecutePipelineRequest,
                    > for ExecutePipelineSvc<T> {
                        type Response = super::ExecutePipelineResponse;
                        type ResponseStream = T::ExecutePipelineStream;
                        type Future = BoxFuture<
                            tonic::Response<Self::ResponseStream>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Firestore>::execute_pipeline(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
