...
The parent runner manifest independently recorded mapped receipt bytes with SHA256 `b96f63483e8215cd65804ed9d100ff177f60e85153e1e6b50895bde865b265df` and sealed its own contents with SHA256 `1e62da98ded06ca800c5fb60ff2be7b784c595ad30c94d4cde31ebc475648d73`. The evaluator emitted its actual HEAD commit `19083f4d0e54d6ff4a2abcd2b3a7459c659cc6b2` and anchor SHA256 `71e6948274cc6e33e20ffb9f5bec356e672fd9129be50d86c8623caf9ed2f35b`, together with the parent and receipt hashes. Saved mode verified these bindings, the parent-owned artifact/commit/configuration identity, the immutable source anchor, the exact `second45-local-run-v1` receipt kind, and both local admission manifest declarations.
...
The positive clean-checkout reproduction detached evaluator commit `19083f4d0e54d6ff4a2abcd2b3a7459c659cc6b2` and ran the same saved command against the frozen private receipt. It returned `match` for 45 rows with no errors.
