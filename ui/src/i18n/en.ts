...
export const en = {
  ...
  "auth.mfaTotp": "TOTP",
  "auth.mfaPhone": "Phone",
  "auth.mfaUnknown": "Unknown factor",
  ...
  "functions.advancedToNextRun": "Advanced the clock to {instant}",
  "functions.invoke": "Invoke",
  "functions.invokeTitle": "Invoke {name}",
  "functions.invokeData": "Data (JSON)",
  "functions.invokeAuthToken": "ID token (optional)",
  "functions.invokeAppCheckToken": "App Check token (optional)",
  "functions.invokeMethod": "Method",
  "functions.invokePath": "Path (optional, appended to the function URL)",
  "functions.invokeQuery": "Query string (optional)",
  "functions.invokeHeaders": "Headers (one per line, Name: value)",
  "functions.invokeBody": "Body (optional)",
  "functions.invokeSend": "Send request",
  "functions.invokeResponse": "Response",
  "functions.invokeStatus": "Status {status} in {ms}ms",
  "functions.invokeTruncated": "Body truncated to the first part; full length {bytes} bytes",
  "functions.invokeUnavailable":
    "The Functions port is not bound, so functions cannot be invoked from here.",
  "functions.enqueue": "Enqueue task",
  "functions.enqueueTitle": "Enqueue a task onto {name}",
  "functions.enqueueData": "Task data (JSON)",
  "functions.enqueueId": "Task ID (optional)",
  "functions.enqueueSend": "Enqueue",
  "functions.enqueued": "Enqueued a task onto {name}",
