...
<head>
<meta charset="utf-8">
<title>firebase-testd UI (not bundled)</title>
<style>
...
fn main() {
    ...
    fs::write(
        out.join("ftd-ui.json"),
        format!("{{\"bundled\": {bundled}}}\n"),
    )
    .expect("write ftd-ui.json");
}
