...
| --- | --- | --- | --- | --- |
| baseline-fresh-finalize | control | accepted / none | claimEmailMatches=True, claimSubMatches=True, derivedLookup=True, idTokenPresent=True, noError=True, refreshTokenPresent=True, secondFactorClaim=True | 4127 |
| trigger | diagnostic | accepted / none | expiresInReturned=False, idTokenReturned=False, noError=True, otherStateUnchanged=True, providerAbsentAfter=True, refreshTokenReturned=False | 5793 |
| held-start | diagnostic | accepted / none | sessionInfoPresent=True | 6074 |
| held-finalize | diagnostic | accepted / none | claimEmailMatches=True, claimSubMatches=True, derivedLookup=True, idTokenPresent=True, noError=True, refreshTokenPresent=True, secondFactorClaim=True | 6618 |
| held-lookup | diagnostic | accepted / none | ownerMatches=True | 6883 |
| held-refresh | diagnostic | accepted / none | bearerType=True, derivedLookup=True, expiryIsPositiveInteger=True, expiryMatchesOneHour=True, idTokenPresent=True, noError=True, refreshTokenPresent=True, uidMatches=True | 7468 |
| final-fresh-finalize | control | accepted / none | claimEmailMatches=True, claimSubMatches=True, derivedLookup=True, idTokenPresent=True, noError=True, refreshTokenPresent=True, secondFactorClaim=True | 9006 |
...
Review subject (unapproved): `8628018a57979e03f35c49950dbd7114e50c8e0b97d0b2f9063f09aa100c2f24`.
...
Recorded with the recorder files at commit `d3c2f4fc3772af8cd9a5095c481e42bc4ee4d299` while the repository was at `d3c2f4fc3772af8cd9a5095c481e42bc4ee4d299`. Re-evaluated at publication with the contract at commit `2a05cf20ec01c4e62a6a1d5d497df2aac51b101f`. The observation itself was not re-run.
