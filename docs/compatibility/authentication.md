...
AUTH-U04 (a held MFA pending credential across a revocation trigger) is being re-published at revision 2 with the completed execution-dependency manifest. Revision 1 is retained as history: [client password change](auth-pending-trigger-client-password-change-r1.md), [administrative password update](auth-pending-trigger-admin-password-update-r1.md), [password reset](auth-pending-trigger-password-reset-r1.md), [provider unlink](auth-pending-trigger-provider-unlink-r1.md).
