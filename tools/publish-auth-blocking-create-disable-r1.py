"""Validate and publish the redacted production-only created-then-disabled receipt (revision 1).
...
BUNDLE = (
    ROOT / "spec/compatibility/evidence/auth-blocking-create-disable-r1/receipt.json"
)
REVIEW = (
    ROOT
    / "spec/compatibility/evidence/auth-blocking-create-disable-r1/source-review.json"
)
PAGE = ROOT / "docs/compatibility/auth-blocking-create-disable-r1.md"
