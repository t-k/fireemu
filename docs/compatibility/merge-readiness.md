...
The [local merge-readiness result](../../spec/compatibility/broad-runs/b33a150c-merge-ready-local.json) binds the technical candidate `b33a150cc3603fd87e6991981c1be9d4ac5f094d` to base `d987d5ddcc1374cee425f08d6d81915795fc2ab5`. It records the workspace, formal, compatibility, SDK, UI and distribution checks without treating local execution as production evidence.
