"""Build and own the strict Auth artifact; run the same refusal-precedence corpus against
...
def run(output):
    ...
    process = None
    with tempfile.TemporaryDirectory(prefix="fireemu-precedence-owned-") as temporary:
...
if __name__ == "__main__":
    ...
    try:
        ...
        raise SystemExit("Precedence owned observation did not complete") from None
