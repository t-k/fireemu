...
from display_name_contract import CASES, complete
from display_name_recorder import PROJECT, recovery_identity, save
...
def test_cleanup_identity_is_persisted_and_rechecked_before_deletion(tmp_path):
    import display_name_recorder as recorder
