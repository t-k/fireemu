...
The original [Firestore v1 gRPC denominator companion](../../spec/compatibility/denominators/firestore-v1-grpc-2026-09-16.v1.json) is immutable historical input. The current [v2 companion](../../spec/compatibility/denominators/firestore-v1-grpc-2026-09-16.v2.json) records the same 502 protobuf surfaces, including 468 Firestore Standard/Native target rows and 34 explicit Enterprise exclusions. Every surface remains `waiting-oracle`; structural enumeration is not production compatibility evidence. SDK and platform combinations are tracked as bounded debt because protobuf descriptors do not enumerate those package and transport contracts. The current companion is fail-closed against its pinned upstream source, generator path and digest, and parent denominator digests.
