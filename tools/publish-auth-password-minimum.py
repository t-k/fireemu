...
sys.path.insert(0, str(ROOT / "tools/auth-password-minimum"))
sys.path.insert(0, str(ROOT / "tools/compat-inventory"))
from evidence_common import runtime_inputs
from minimum_contract import CASES, complete, require, validate_case
from minimum_recorder import PASSWORD_POLICY, digest, inputs

BUNDLE = ROOT / "spec/compatibility/evidence/auth-password-minimum/receipt.json"
REVIEW = ROOT / "spec/compatibility/evidence/auth-password-minimum/source-review.json"
PAGE = ROOT / "docs/compatibility/auth-password-minimum.md"
INPUT_SHAPE = {
