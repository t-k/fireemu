...
//!
//! Base64url is not reimplemented here: `fireemu_core_auth::jwt` already carries the unpadded
...
pub use fireemu_core_auth::jwt::base64url_encode;
...
pub fn base64url_decode(text: &str) -> Result<Vec<u8>, AppCheckFailure> {
    fireemu_core_auth::jwt::base64url_decode(text).map_err(|_| AppCheckFailure::Malformed)
}
