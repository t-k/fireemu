...
pub mod firestore_admin_server {
    ...
    pub trait FirestoreAdmin: std::marker::Send + std::marker::Sync + 'static {
        ...
        async fn create_user_creds(
            &self,
            request: tonic::Request<super::CreateUserCredsRequest>,
        ) -> std::result::Result<tonic::Response<super::UserCreds>, tonic::Status>;
        /// Gets a user creds resource. Note that the returned resource does not
        /// contain the secret value itself.
        async fn get_user_creds(
            &self,
            request: tonic::Request<super::GetUserCredsRequest>,
        ) -> std::result::Result<tonic::Response<super::UserCreds>, tonic::Status>;
        /// List all user creds in the database. Note that the returned resource
        /// does not contain the secret value itself.
        async fn list_user_creds(
            &self,
            request: tonic::Request<super::ListUserCredsRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ListUserCredsResponse>,
            tonic::Status,
        >;
        ...
        async fn enable_user_creds(
            &self,
            request: tonic::Request<super::EnableUserCredsRequest>,
        ) -> std::result::Result<tonic::Response<super::UserCreds>, tonic::Status>;
        /// Disables a user creds. No-op if the user creds are already disabled.
        async fn disable_user_creds(
            &self,
            request: tonic::Request<super::DisableUserCredsRequest>,
        ) -> std::result::Result<tonic::Response<super::UserCreds>, tonic::Status>;
        /// Resets the password of a user creds.
        ...
        async fn delete_user_creds(
            &self,
            request: tonic::Request<super::DeleteUserCredsRequest>,
        ) -> std::result::Result<tonic::Response<()>, tonic::Status>;
        /// Gets information about a backup.
        async fn get_backup(
            &self,
        ...
        async fn clone_database(
            &self,
            request: tonic::Request<super::CloneDatabaseRequest>,
        ) -> std::result::Result<
            tonic::Response<super::super::super::super::longrunning::Operation>,
            tonic::Status,
        >;
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/google.firestore.admin.v1.FirestoreAdmin/CreateUserCreds" => {
                    #[allow(non_camel_case_types)]
                    struct CreateUserCredsSvc<T: FirestoreAdmin>(pub Arc<T>);
                    impl<
                        T: FirestoreAdmin,
                    > tonic::server::UnaryService<super::CreateUserCredsRequest>
                    for CreateUserCredsSvc<T> {
                        type Response = super::UserCreds;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as FirestoreAdmin>::create_user_creds(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = CreateUserCredsSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/google.firestore.admin.v1.FirestoreAdmin/GetUserCreds" => {
                    #[allow(non_camel_case_types)]
                    struct GetUserCredsSvc<T: FirestoreAdmin>(pub Arc<T>);
                    impl<
                        T: FirestoreAdmin,
                    > tonic::server::UnaryService<super::GetUserCredsRequest>
                    for GetUserCredsSvc<T> {
                        type Response = super::UserCreds;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as FirestoreAdmin>::get_user_creds(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = GetUserCredsSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/google.firestore.admin.v1.FirestoreAdmin/ListUserCreds" => {
                    #[allow(non_camel_case_types)]
                    struct ListUserCredsSvc<T: FirestoreAdmin>(pub Arc<T>);
                    impl<
                        T: FirestoreAdmin,
                    > tonic::server::UnaryService<super::ListUserCredsRequest>
                    for ListUserCredsSvc<T> {
                        type Response = super::ListUserCredsResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as FirestoreAdmin>::list_user_creds(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = ListUserCredsSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/google.firestore.admin.v1.FirestoreAdmin/EnableUserCreds" => {
                    #[allow(non_camel_case_types)]
                    struct EnableUserCredsSvc<T: FirestoreAdmin>(pub Arc<T>);
                    impl<
                        T: FirestoreAdmin,
                    > tonic::server::UnaryService<super::EnableUserCredsRequest>
                    for EnableUserCredsSvc<T> {
                        type Response = super::UserCreds;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as FirestoreAdmin>::enable_user_creds(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = EnableUserCredsSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/google.firestore.admin.v1.FirestoreAdmin/DisableUserCreds" => {
                    #[allow(non_camel_case_types)]
                    struct DisableUserCredsSvc<T: FirestoreAdmin>(pub Arc<T>);
                    impl<
                        T: FirestoreAdmin,
                    > tonic::server::UnaryService<super::DisableUserCredsRequest>
                    for DisableUserCredsSvc<T> {
                        type Response = super::UserCreds;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as FirestoreAdmin>::disable_user_creds(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = DisableUserCredsSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/google.firestore.admin.v1.FirestoreAdmin/ResetUserPassword" => {
                    #[allow(non_camel_case_types)]
                    struct ResetUserPasswordSvc<T: FirestoreAdmin>(pub Arc<T>);
                    impl<
                        T: FirestoreAdmin,
                    ...
                    for ResetUserPasswordSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as FirestoreAdmin>::reset_user_password(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                ...
                "/google.firestore.admin.v1.FirestoreAdmin/DeleteUserCreds" => {
                    #[allow(non_camel_case_types)]
                    struct DeleteUserCredsSvc<T: FirestoreAdmin>(pub Arc<T>);
                    impl<
                        T: FirestoreAdmin,
                    > tonic::server::UnaryService<super::DeleteUserCredsRequest>
                    for DeleteUserCredsSvc<T> {
                        type Response = ();
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as FirestoreAdmin>::delete_user_creds(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = DeleteUserCredsSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/google.firestore.admin.v1.FirestoreAdmin/CloneDatabase" => {
                    #[allow(non_camel_case_types)]
                    struct CloneDatabaseSvc<T: FirestoreAdmin>(pub Arc<T>);
                    impl<
                        T: FirestoreAdmin,
                    > tonic::server::UnaryService<super::CloneDatabaseRequest>
                    for CloneDatabaseSvc<T> {
                        type Response = super::super::super::super::longrunning::Operation;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as FirestoreAdmin>::clone_database(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = CloneDatabaseSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
