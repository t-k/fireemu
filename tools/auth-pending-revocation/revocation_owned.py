"""Build and own the strict Auth artifact; run the same pending-revocation corpus against
...
from revocation_recorder import (
    PROJECT,
    ROOT,
    complete,
    inputs,
...
def run(output):
    ...
    process = None
    with tempfile.TemporaryDirectory(prefix="fireemu-revocation-owned-") as temporary:
