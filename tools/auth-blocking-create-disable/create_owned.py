"""Build and own the strict Auth artifact with the local created-then-disabled fixture;
run the same corpus against it. Never attaches to an external daemon."""
...
def run(output):
    ...
    with tempfile.TemporaryDirectory(
        prefix="fireemu-create-disable-owned-"
    ) as temporary:
...
if __name__ == "__main__":
    ...
    try:
        ...
        raise SystemExit("Create-disable owned observation did not complete") from None
