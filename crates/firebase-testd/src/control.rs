...
pub fn capabilities_manifest() -> Value {
    json!({
        ...
        "capabilities": {
            ...
            "CTL-1-AWAIT-IDLE": {"status": "partial", "implemented": ["POST /v1/sessions/{s}:awaitIdle waits for pending / running / retry-waiting events and HTTP invocations"], "unimplemented": ["causal fences across sessions", "Text Index work"]},
