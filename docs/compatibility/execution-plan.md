...
| FS-EVID-001 | R | FS-DATA-WRITE | no saved-reference replay on the current artifact | PROD-DIFF-PILOT-001 | first46, second45, G0, limits-02, write-txn, Commit replays bound to the final artifact, run through the pilot runner once it lands | at G1, after the pilot |
