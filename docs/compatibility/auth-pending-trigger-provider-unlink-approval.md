# Held MFA pending credential across provider-unlink: scoped human approval
...
[Approval record](../../spec/compatibility/evidence/auth-pending-trigger-provider-unlink/approval.json) · [Receipt](../../spec/compatibility/evidence/auth-pending-trigger-provider-unlink/receipt.json) · [Candidate page](auth-pending-trigger-provider-unlink.md).
