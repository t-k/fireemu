...
def test_manifest_is_exactly_six_owned_explain_cases():
    value = manifest()
    assert value["kind"] == "production-campaign-explain-01-v6"
...
def test_checked_in_manifest_and_binding_are_stable():
    path = (
        ...
        / "spec/compatibility/broad-runs/prod-campaign-explain-01-v6.json"
    )
    binding_path = path.with_name("prod-campaign-explain-01-v6-binding.json")
