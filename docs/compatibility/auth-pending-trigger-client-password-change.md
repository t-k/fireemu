...
| --- | --- | --- | --- | --- |
| baseline-fresh-finalize | control | accepted / none | claimEmailMatches=True, claimSubMatches=True, derivedLookup=True, idTokenPresent=True, noError=True, refreshTokenPresent=True, secondFactorClaim=True | 3556 |
| trigger | diagnostic | accepted / none | accountPresent=True, expiresInReturned=True, idTokenReturned=True, noError=True, refreshTokenReturned=True | 5206 |
| held-start | diagnostic | accepted / none | sessionInfoPresent=True | 5512 |
| held-finalize | diagnostic | accepted / none | claimEmailMatches=True, claimSubMatches=True, derivedLookup=True, idTokenPresent=True, noError=True, refreshTokenPresent=True, secondFactorClaim=True | 6117 |
| held-lookup | diagnostic | accepted / none | ownerMatches=True | 6403 |
| held-refresh | diagnostic | accepted / none | bearerType=True, derivedLookup=True, expiryIsPositiveInteger=True, expiryMatchesOneHour=True, idTokenPresent=True, noError=True, refreshTokenPresent=True, uidMatches=True | 6997 |
| final-fresh-finalize | control | accepted / none | claimEmailMatches=True, claimSubMatches=True, derivedLookup=True, idTokenPresent=True, noError=True, refreshTokenPresent=True, secondFactorClaim=True | 8161 |
...
Review subject (unapproved): `698884037cb56f6ec50d5656fb57b490512c26556eae58c35e7147bd581aa1d6`.
