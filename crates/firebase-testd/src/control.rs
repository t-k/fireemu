...
pub fn capabilities_manifest() -> Value {
    json!({
        ...
        "capabilities": {
            ...
            "STORAGE-RULES-1": {"status": "partial", "implemented": ["service firebase.storage: get / list / create / update / delete with request.resource and resource", "Firebase protocol goes through the rules; the JSON API is a privileged surface"], "unimplemented": ["firestore.get() / firestore.exists()"]},
