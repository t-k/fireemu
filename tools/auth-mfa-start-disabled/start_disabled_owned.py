"""Build and own the strict Auth artifact; run the same mfa-start-disabled corpus against
...
from start_disabled_recorder import (
    PROJECT,
    ROOT,
    complete,
    inputs,
...
def run(output):
    ...
    with tempfile.TemporaryDirectory(
        prefix="fireemu-start-disabled-owned-"
    ) as temporary:
...
if __name__ == "__main__":
    ...
    try:
        ...
        raise SystemExit("Start-disabled owned observation did not complete") from None
