...
const CLAIM_CASES = [
  ...
  ["tenant-suffix-4", `${T}.firebase.tenant.matches('fsr-tenant-[a-z0-9]{4}')`],
  ["tenant-suffix-5", `${T}.firebase.tenant.matches('fsr-tenant-[a-z0-9]{5}')`],
  ["tenant-suffix-6", `${T}.firebase.tenant.matches('fsr-tenant-[a-z0-9]{6}')`],
  ["tenant-suffix-digits", `${T}.firebase.tenant.matches('fsr-tenant-[0-9]+')`],
